<div>
    <header class="mt-24 mb-16 mx-24">
        <img src="{{ asset('img/logo-giro-valas.png') }}" alt="Logo Header" id="animate" class="mx-auto w-1/2">
        <p id="animate" class="font-montserrat text-xl tracking-wide text-white text-center mt-10">
            Giro valas BRI adalah simpanan dalam mata uang asing yang bisa ditarik kapan saja menggunakan surat perintah
            penarikan sesuai ketentuan BRI.
        </p>
    </header>
    <main class="mx-20 font-montserrat tracking-widest">
        @php
            $firstRow = $valuesGiroValas[0];
        @endphp
        ...
        @foreach (array_slice($valuesGiroValas, 1) as $row)
