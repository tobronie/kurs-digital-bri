<div>
    <header class="mt-24 mb-16 mx-24">
        <img src="{{ asset('img/logo-giro-rupiah.png') }}" alt="Logo Header" id="animate" class="mx-auto w-1/2">
        <p id="animate" class="font-montserrat text-xl tracking-wide text-white text-center mt-10">
            Giro rupiah BRI adalah simpanan dalam mata uang rupiah yang dapat ditarik kapan saja dengan menggunakan cek,
            bilyet giro, kartu ATM, atau surat perintah lainnya.
        </p>
    </header>
    <main class="mx-20 font-montserrat tracking-widest">
        @php
            $firstRow = $valuesGiroRupiah[0];
        @endphp
        ...
        @foreach (array_slice($valuesGiroRupiah, 1) as $row)
